...
import (
	...
	"microservice-challenge/services/sales/docs"
	"microservice-challenge/services/sales/httphandler"
	"microservice-challenge/services/sales/router/internal"
	"net/http"
	"time"
...
func NewRouter(handler *httphandler.Handler, logger log.Logger, jwtSecret string, db *sql.DB) http.Handler {
	...
	docs.SwaggerInfo.Host = "localhost:8004"
	...
	healthCheck := health.New("sales-service", "1.0.0")
	if db != nil {
	...
	r.Route("/", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			internal.InitSalesRoutes(r, handler, authMiddleware)
		})
	})
