...
// @Success      200 {object} response.Response{data=[]model.SalesOrder}
...
// @Success      200 {object} response.Response{data=model.SalesOrderWithItems}
// @Failure      401 {object} response.Response
// @Failure      403 {object} response.Response
...
// @Success      201 {object} response.Response{data=model.SalesOrderWithItems}
