...
import (
	...
	"microservice-challenge/services/purchase/docs"
	"microservice-challenge/services/purchase/httphandler"
	"microservice-challenge/services/purchase/router/internal"
	"net/http"
	"time"
...
func NewRouter(handler *httphandler.Handler, logger log.Logger, jwtSecret string, db *sql.DB) http.Handler {
	...
	docs.SwaggerInfo.Host = "localhost:8005"
	...
	healthCheck := health.New("purchase-service", "1.0.0")
	if db != nil {
	...
	r.Route("/", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			internal.InitPurchaseRoutes(r, handler, authMiddleware)
		})
	})
